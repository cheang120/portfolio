    ...
    <div className='dark:bg-stone-800 bg-peach-300 flex flex-col gap-3'>
      {data.map((item,index) => (
        <div key={index} className='dark:bg-stone-900  bg-peach-600 px-5 rounded-lg'>
            ...
            >
                <h6 className='dark:text-peach-700 text-grey-700'>{item.certName}</h6>
            ...
            <div className={`dark:bg-stone-900 dark:text-peach-700 flex justify-between bg-peach-600 text-grey-600 transition-all duration-300 ${
