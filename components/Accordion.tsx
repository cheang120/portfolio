...
const Accordion = ({data} : {data: AccordionData[]}) => {
  ...
  return (
    <div className='dark:bg-stone-800 bg-peach-300 flex flex-col gap-3'>
      {data.map((item,index) => (
        <div key={index} className='dark:bg-stone-900 bg-peach-300 bg-peach-600 px-5 rounded-lg'>
            <div 
                className='dark:bg-stone-900 bg-peach-300 flex items-center justify-between cursor-pointer py-5'
            ...
            <div className={`dark:bg-stone-900 dark:text-peach-700 bg-peach-300 text-grey-600 transition-all duration-300 ${
